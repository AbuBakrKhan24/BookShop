<template>
  <div v-if="book">
    ...
    <div class="displaySingle mt-5 row d-flex justify-content-center mx-5 px-5">
      <div class="singleBookCard col-md-6">
        <img v-bind:src="book.cover" />
        <p>{{ book.title }}</p>
        <a :href="book.file" target="_blank"><button class="btn btn-outline-secondary">Download Now</button></a>
        <button
    ...
    >
      ...
      <div class="displaySingleDetails col-md-6">
        <p></p>
